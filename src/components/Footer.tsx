...
export const Footer: FC = () => {
    return (
        <div className="flex flex-row invisible md:visible place-content-between fixed bottom-0 w-screen">

            <div className='items-start m-4'>
                <img className="w-32 md:w-44" src="img/logo copy.png" />
                <p className="font-bold text-xs tracking-tighter md:text-base">
                    Nico Lacerenza Visual/Sound Artist
                </p>
            </div>

            <div className="flex flex-row w-fit mx-4 gap-1 place-content-end ">

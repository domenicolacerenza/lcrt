      ...
      <Folder id={1} title={"Music"} mLink={""}
        modalWindow={
          <>
            ...
            <div className="flex flex-row md:gap-24 gap-10 place-items-center md:-mb-4 mb-12">
      ...
      <Folder id={3} title={"Portfolio"} mLink=""
        modalWindow={
          ...
          <>
           ...
           16:9 HD 14:26 minutes </p>} modalFrameSrc="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/1648980045&color=%239f7369&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true&visual=true" />
            ...
            <Card id={14} title={"Human Interaction"} subtitle={"(printable PDF fanzine,SoundArt track, Video 2:20 min, Stereo)"} imgSrc="/img/hi.jpg"
              ...
              modalContent={
                <div className=" place-items-center">
                  <p className="tracking-tight font-light md:text-lg text-xs"> For <Link className="underline" href="https://accademiaunidee.it/it/art-summer-school-borders-boundaries/">
                  ...
                  <div className="flex justify-center w-full -mb-10">
                    <Link href="/docs/rebuilding memories.pdf">

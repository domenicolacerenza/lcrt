...
export const Card = ({
    ...
    return (
        <div>
                ...
                <div className="modal-box w-2/3 bg-zinc-800/85">
...

                    {
                        modalWindow ? modalWindow
                            : modalFrameSrc ?
                                <iframe className="mx-auto w-auto h-44 max-w-xl min-w-full" allow="autoplay" src={modalFrameSrc} width="300" height="640" />
                    ...
                    <p className=" py-8 mb:-mb-20 -mb-14">
                        {
            ...
            <div className="card md:w-56 w-48 md:h-64 h-56 bg-neutral-950/80">
              
                <div className="card-body mr-2 -ml-4">
                    <h2 className=" text-lg font-medium -mt-2 mb-4">{title}</h2>
                    <p className=" md:text-sm text-xs font-extralight -mb-12">{subtitle} </p>
                </div>

                <div className="card-actions place-content-between m-4">

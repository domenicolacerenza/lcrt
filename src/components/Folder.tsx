...
export const Folder = ({
    ...
    return (
        <div>
            <label htmlFor={"fold_" + String(id)} className="btn btn-md btn-ghost backdrop-blur-sm bg-[#ef8474]/20 font-medium text-2xl  text-[#d7bdb6]">{title}</label>
                    ...
                    <div className="flex flex-wrap mx-auto place-content-center md:gap-6 gap-4 mb-12 md:p-8 p-4">{modalWindow}</div>
                    {
                        mLink ?
                            <div className="md:fixed bottom-2 left-0 place-content-center flex h-6 w-full items-end justify-center mt-12">
                                <div className='flex flex-row mx-auto w-fit gap-6 m-2 mb-4'>

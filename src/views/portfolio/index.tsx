            ...
            <div className="flex flex-col" role="main">
                <div className="flex flex-wrap mx-auto place-content-center gap-8 md:m-8 md:mb-40 mb-8">
                    ...
                    <Card id={3} title={"BD LEARNED HOW TO WASH HANDS"} subtitle={"(SoundArt track, 8 min, Stereo)"}
                        content={"part of ALL IN ONE | RAVA VAVARA for PILLOW TALK - MATERIA GALLERY"} modalWindow={
                            <div>
                                ...
                                by Eva Macali for POLVERE Podcast BY PILLOW TALK - MATERIA GALLERY ROME</p>} appleL={""} spotiL={""} bandcL={""} ></Card>
                    ...
                    <Card id={4} title={"Human Iteraction"} subtitle={"(printable PDF fanzine,SoundArt track, Video 2:20 min, Stereo)"} imgSrc="/img/hi.jpg"
                        ...
                        modalWindow={
                            <div><div className="carousel w-full">
                                ...
                                <div id="item7" className="carousel-item w-full">
                                    <img className='rounded-[15px] w-fit h-96' src="/img/zine.jpg" alt="Zine" />
                                </div>
                                <div id="item8" className="carousel-item w-full">
                                    <img className='rounded-[15px] w-fit h-96' src="/img/human.jpg" alt="fanzine" />
                                </div>
                        ...
                        appleL={""} spotiL={""} bandcL={""} content={"Accademia Unidee residency (09/2020)"} modalFrameSrc="" ></Card>
                    ...
                    <Card title={"ecodrop"} id={6} subtitle={"(3d Sculpture, SoundArt track 11:25 min, Stereo)"}
                        ...
                        content={undefined} appleL={""} spotiL={""} bandcL={""}        ></Card>
                    ...
                    <Card title={"GINNASTICA 0001 [2022 - 11 - 24]"} id={7} subtitle={"(SoundArt track 17:26 min, Stereo)"}
                        ...
                        content={undefined} appleL={""} spotiL={""} bandcL={""}        ></Card>
                    <Card title={"Danza (from DIARIO SIAMESE"} subtitle={"(SoundArt track 2:08 mim, Stereo)"} content={undefined} appleL={""} spotiL={""} bandcL={""}

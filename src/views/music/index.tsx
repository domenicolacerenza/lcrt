    ...
    <div className="w-screen max-h-screen p-4 ">
      <div className="flex flex-col">
        <div className="flex flex-wrap mx-auto place-content-center gap-8 md:m-8 md:mb-40 mb-24">
          ...
          <Card id={9} title={"MULTIBAND DREAM-FUSION - Single"} subtitle={"20/07/2023"}
            ...
            </div>} content={undefined} appleL={""} spotiL={""} bandcL={"https://lcrt.bandcamp.com/track/multiband-dream-fusion"} />

          <Card id={8} title={"(LOOK AT U) ✧⎋ - Single"} subtitle={"23/06/2023"}
            ...
            </div>} content={undefined} appleL={""} spotiL={""} bandcL={"https://lcrt.bandcamp.com/track/look-at-u"} />

          <Card id={7} title={"messy love - Single"} subtitle={"09/06/2023"}
          ...
          <Card id={6} title={"Al Chiar Di Luna (HOWL) - Single"} subtitle={"26/03/2023"}
          ...
          <Card id={5} title={"BELFAGOR [magica_me XTRM]"} subtitle={"18/01/2023"} modalFrameSrc={"https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/1426775251&color=%237471b6&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true&visual=true"}
            modalContent={<div className="flex flex-row mx-auto w-fit m-2">
              <button className="btn bg-black btn-circle">
                <a href="https://lcrt.bandcamp.com/track/belfagor-magica-me-xtrm">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30" width="30" height="30" fill="currentColor">
                    <path d="M15,3C8.373,3,3,8.373,3,15s5.373,12,12,12s12-5.373,12-12S21.627,3,15,3z M17.333,18.774H8.578l4.089-7.547h8.755L17.333,18.774z" fill-rule="evenodd" clip-rule="evenodd" /></svg>
                </a>
              </button>

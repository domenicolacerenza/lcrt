  ...
  return (
    <div className='md:hero mx-auto mb-96'>
      <div className="flex max-h-96 md:max-h-auto flex-wrap mt-96 mx-auto md:mt-8 content-start place-content-center gap-8">
        ...
        <Card id={10} title={"Battle - Single"} subtitle={"01/02/2019"}
        ...
        spotiL="https://open.spotify.com/track/5Bg9cWqbkpTTY20V8pms5X?utm_medium=share&utm_source=lcrtxyz" bandcL="https://lcrt.bandcamp.com/track/battle" content={""}        ></Card>

        <Card id={11} title={"untitled folder.zip - EP"} subtitle={"27/09/2019"}
        ...
        spotiL="https://open.spotify.com/album/6Jn6PMdFKzJOll6mQ7qjmH?utm_medium=share&utm_source=lcrtxyz" bandcL="https://lcrt.bandcamp.com/album/untiled-folder-zip" content={""}        ></Card>

        <Card id={12} title={"Fuck U 2 - Single"} subtitle={"06/09/2020"}
        ...
        spotiL="https://open.spotify.com/track/327Ku7AXBjLc07mX6aZ6ii?utm_medium=share&utm_source=lcrtxyz" bandcL="https://lcrt.bandcamp.com/track/fuck-u-2" content={undefined}        ></Card>

        <Card id={13} title={"DESTINO - Single"} subtitle={"06/10/2022"}
        ...
        spotiL="https://open.spotify.com/album/1n7NzUBDfyngN4rGhFwJwK?si=qVXrvyS3TeK7LS0Gcrlz8g&utm_medium=share&utm_source=lcrtxyz" bandcL="https://lcrt.bandcamp.com/track/destino" content={undefined}        ></Card>

        <Card id={14} title={"Al Chiar Di Luna (HOWL) - Single"} subtitle={"26/03/2023"}
        ...
        spotiL="https://open.spotify.com/album/5gRiVXegJtfSPqWLKu5hQw?si=DJmzIpwsRPqsC5OQpFCXSA&utm_medium=share&utm_source=lcrtxyz" bandcL="https://lcrt.bandcamp.com/track/al-chiar-di-luna-howl" content={undefined}        ></Card>

        <Card id={15} title={"messy love - Single"} subtitle={"09/06/2023"}
        ...
        spotiL="https://open.spotify.com/track/7mRefub1LqNiUZCQ8WCtxu?utm_medium=share&utm_source=lcrtxyz" bandcL="https://lcrt.bandcamp.com/track/messy-love" content={undefined}        ></Card>

        <Card id={16} title={"(LOOK AT U) ✧⎋ - Single"} subtitle={"23/06/2023"}
        ...
        modalContent={<div className="flex flex-row mx-auto w-fit mx-4 m-2">
        ...
        </div>} content={undefined} appleL={""} spotiL={""} bandcL={""}        ></Card>
        <Card id={17} title={"MULTIBAND DREAM-FUSION - Single"} subtitle={"20/07/2023"}

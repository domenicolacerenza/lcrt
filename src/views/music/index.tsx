      ...
      <div className="flex flex-col">
        <div className="flex flex-wrap mx-auto place-content-center gap-8 md:m-8 md:mb-40 mb-8">
          ...
          <Card id={8} title={"MULTIBAND DREAM-FUSION - Single"} subtitle={"20/07/2023"}
            ...
            <Card id={9} title={"dirty - Single"} subtitle={"27/10/2023"} content={undefined} appleL={"https://music.apple.com/it/album/dirty-single/1713022032?l=en-GB"} 

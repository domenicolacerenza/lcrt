...
export const HomeView: FC = ({ }) => {
  return (
    ...
    <div className='md:hero mx-auto w-3/5'>
      ...
      <div className="md:static flex max-h-screen md:max-h-fit flex-wrap mx-auto mt-60 md:mt-0 content-start place-content-center gap-8 mb-20 md:mb-0">
        ...
        <div className='place-content-center mt-0 md:mt-8'>
